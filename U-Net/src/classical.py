...
def run_classical_pipeline():
    ...
    # Finding image number from given cli arguement from train data
    image = train[int(sys.argv[1])]
    # Running lane detection pipeline on the image
    images = lane_detection_classical(image)
    # Adding the ground truth image to the list of images
